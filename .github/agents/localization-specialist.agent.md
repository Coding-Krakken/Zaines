...
description: Internationalization, localization, and translation specialist. Enables multi-language and multi-region support.
---
...
Task: [specific i18n/localization objective]
```
