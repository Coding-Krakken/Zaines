...
description: Performance budgets, profiling, and optimization expert. Ensures fast, efficient user experience.
---
...
Task: [specific optimization architecture objective]
```
