...
import { BadgeCheck, Scissors, ArrowRight } from "lucide-react";
            ...
            <CardContent className="space-y-8 p-8 md:p-10">
              <div className="text-center">
                ...
                <h1 className="headline-display mb-4 text-4xl font-semibold md:text-5xl">
                  Grooming Is Not Standalone Today
                </h1>
                <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
                  Our team is currently focused on delivering premium private boarding.
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <ScaleIn>
                  <div className="luxury-card p-5">
                    ...
                    <h2 className="mb-2 text-base font-semibold text-foreground">What remains available</h2>
                    <p className="text-sm text-muted-foreground">
                      Boarding stays include structured care and add-ons configured during your booking flow.
                    </p>
                  </div>
                </ScaleIn>
                <ScaleIn delay={0.06}>
                  <div className="luxury-card p-5">
                    ...
                    <h2 className="mb-2 text-base font-semibold text-foreground">Future roadmap</h2>
                    <p className="text-sm text-muted-foreground">
                      If grooming launches as a standalone offer, we will publish packages and policies here first.
                    </p>
                  </div>
                </ScaleIn>
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
                ...
                <Button variant="outline" className="focus-ring" asChild>
                  <Link href="/pricing">View Boarding Pricing</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
